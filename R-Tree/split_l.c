...
-----------------------------------------------------------------------------*/
static void RTreeGetBranches(struct RNode *N, struct Branch *B)
{
...
-----------------------------------------------------------------------------*/
static void RTreeLoadNodes(struct RNode *N, struct RNode *Q,
			struct PartitionVars *P)
{
	register struct RNode *n = N, *q = Q;
	register struct PartitionVars *p = P;
	register int i;
	assert(n);
	assert(q);
...
-----------------------------------------------------------------------------*/
void RTreeSplitNode(struct RNode *n, struct Branch *b, struct RNode **nn)
{
